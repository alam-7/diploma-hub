...
var MSBTE_K_SCHEME = {
        ...
        semesters: {
            1: {
                ...
                subjects: [
                    ...
                    { code: '311303', name: 'Communication Skills (English)', shortName: 'CSE', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 16, tutorial: 0 } },
                    ...
                    { code: '311003', name: 'Yoga and Meditation', shortName: 'YM', type: 'Practical', credits: 1, marks: 25, hours: { theory: 0, practical: 16, tutorial: 0 } },
            ...
            2: {
                ...
                subjects: [
                    { code: '312301', name: 'Applied Mathematics', shortName: 'AMS', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 16 } },
                    { code: '312303', name: 'Programming in C', shortName: 'C Programming', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    ...
                    { code: '312304', name: 'Web Page Designing', shortName: 'WPD', type: 'Practical', credits: 2, marks: 50, hours: { theory: 16, practical: 32, tutorial: 0 } },
                    { code: '312002', name: 'Professional Communication', shortName: 'PC', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 16, tutorial: 0 } }
                ]
            },
            3: {
                name: 'Semester 3',
                ...
                subjects: [
                    ...
                    { code: '313304', name: 'Object Oriented Programming Using C++', shortName: 'OOP', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '313303', name: 'Digital Techniques', shortName: 'DT', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } }
                ]
            },
            4: {
                name: 'Semester 4',
                ...
                subjects: [
                    ...
                    { code: '314318', name: 'Data Communication and Computer Network', shortName: 'DCCN', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314319', name: 'Information Security', shortName: 'IS', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '314301', name: 'Environmental Education and Sustainability', shortName: 'EES', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            5: {
                name: 'Semester 5',
                ...
                subjects: [
                    ...
                    { code: '315325', name: 'Cloud Computing', shortName: 'CC', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '315301', name: 'Management', shortName: 'MGT', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            6: {
                name: 'Semester 6',
                ...
                subjects: [
                    { code: '316313', name: 'Emerging Trends in Computer Engineering', shortName: 'ETCE', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316316', name: 'Machine Learning', shortName: 'ML', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '316318', name: 'Big Data Analytics', shortName: 'BDA', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '316320', name: 'Capstone Project', shortName: 'Project', type: 'Project', credits: 6, marks: 150, hours: { theory: 0, practical: 96, tutorial: 0 } }
                ]
            }
        }
    },
    ...
    'civil-engineering': {
        ...
        semesters: {
            ...
            2: {
                ...
                subjects: [
                    { code: '312301', name: 'Applied Mathematics', shortName: 'AMS', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 16 } },
                    { code: '312308', name: 'Applied Science', shortName: 'ASC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    ...
                    { code: '312338', name: 'Building Material and Construction', shortName: 'BMC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '312339', name: 'Surveying', shortName: 'SUR', type: 'Practical', credits: 4, marks: 100, hours: { theory: 32, practical: 48, tutorial: 0 } },
                    { code: '312002', name: 'Professional Communication', shortName: 'PC', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 16, tutorial: 0 } },
                    { code: '312003', name: 'Social and Life Skills', shortName: 'SLS', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            3: {
                name: 'Semester 3',
                ...
                subjects: [
                    ...
                    { code: '313321', name: 'Advanced Surveying', shortName: 'ASUR', type: 'Practical', credits: 4, marks: 100, hours: { theory: 32, practical: 48, tutorial: 0 } },
                    ...
                    { code: '313323', name: 'Highway Engineering', shortName: 'HE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '313002', name: 'Essence of Indian Constitution', shortName: 'EIC', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } },
                    { code: '313009', name: 'Building Planning and Drawing with CAD', shortName: 'BPDC', type: 'Practical', credits: 4, marks: 100, hours: { theory: 16, practical: 48, tutorial: 0 } }
                ]
            },
            4: {
                name: 'Semester 4',
                ...
                subjects: [
                    ...
                    { code: '314312', name: 'Railway, Bridge and Tunnel Engineering', shortName: 'RBTE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '314313', name: 'Estimating, Costing and Valuation', shortName: 'ECV', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314314', name: 'Water and Wastewater Engineering', shortName: 'WWE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
            ...
            5: {
                ...
                subjects: [
                    ...
                    { code: '315315', name: 'Emerging Trends in Civil Engineering', shortName: 'ETCE', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '315316', name: 'Energy Conservation & Green Building', shortName: 'ECGB', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '315301', name: 'Management', shortName: 'MGT', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } },
                    { code: '315004', name: 'Internship - 12 Weeks', shortName: 'INT', type: 'Internship', credits: 6, marks: 150, hours: { theory: 0, practical: 192, tutorial: 0 } }
                ]
            },
            6: {
                name: 'Semester 6',
                ...
                subjects: [
                    { code: '316307', name: 'Contracts and Billing', shortName: 'CB', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316308', name: 'Design of RCC and Steel Structures', shortName: 'DRSS', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '316309', name: 'Maintenance and Repairs of Structures', shortName: 'MRS', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316312', name: 'Solid Waste Management', shortName: 'SWM', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316004', name: 'Capstone Project', shortName: 'Project', type: 'Project', credits: 6, marks: 150, hours: { theory: 0, practical: 96, tutorial: 0 } }
                ]
            }
        }
    },
        ...
        semesters: {
            ...
            2: {
                ...
                subjects: [
                    ...
                    { code: '312315', name: 'Elements of Electrical Engineering', shortName: 'EEE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } }
                ]
            },
            3: {
                name: 'Semester 3',
                ...
                subjects: [
                    ...
                    { code: '313334', name: 'Electrical and Electronic Measurement', shortName: 'EEM', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '313335', name: 'Fundamentals of Power Electronics', shortName: 'FPE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '313333', name: 'Electrical Power Generation, Transmission and Distribution', shortName: 'EPGTD', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } }
                ]
            },
            4: {
                name: 'Semester 4',
                ...
                subjects: [
                    ...
                    { code: '314324', name: 'Digital Electronics and Microcontroller Applications', shortName: 'DEMA', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    ...
                    { code: '314325', name: 'Electrical Estimating and Contracting', shortName: 'EEC', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '314301', name: 'Environmental Education and Sustainability', shortName: 'EES', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            5: {
                ...
                subjects: [
                    ...
                    { code: '315335', name: 'Power System Operation and Control', shortName: 'PSOC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '315301', name: 'Management', shortName: 'MGT', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } },
                    { code: '315004', name: 'Internship - 12 Weeks', shortName: 'INT', type: 'Internship', credits: 6, marks: 150, hours: { theory: 0, practical: 192, tutorial: 0 } }
                ]
            },
            6: {
                ...
                subjects: [
                    ...
                    { code: '316337', name: 'Energy Conservation and Audit', shortName: 'ECA', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316338', name: 'Maintenance of Electrical Equipment', shortName: 'MEE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '316004', name: 'Capstone Project', shortName: 'Project', type: 'Project', credits: 6, marks: 150, hours: { theory: 0, practical: 96, tutorial: 0 } }
                ]
            }
        }
        ...
        semesters: {
            ...
            3: {
                ...
                subjects: [
                    ...
                    { code: '313343', name: 'Thermodynamics', shortName: 'TD', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '313344', name: 'Engineering Drawing / CAD', shortName: 'EDC', type: 'Practical', credits: 4, marks: 100, hours: { theory: 16, practical: 48, tutorial: 0 } }
                ]
            },
            4: {
                name: 'Semester 4',
                ...
                subjects: [
                    ...
                    { code: '314347', name: 'Manufacturing Technology', shortName: 'MT', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314348', name: 'Machine Design', shortName: 'MD', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314301', name: 'Environmental Education and Sustainability', shortName: 'EES', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            5: {
                ...
                subjects: [
                    ...
                    { code: '315351', name: 'Thermal Engineering', shortName: 'TE', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '315301', name: 'Management', shortName: 'MGT', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } },
                    { code: '315004', name: 'Internship - 12 Weeks', shortName: 'INT', type: 'Internship', credits: 6, marks: 150, hours: { theory: 0, practical: 192, tutorial: 0 } }
                ]
            },
            6: {
                ...
                subjects: [
                    ...
                    { code: '316353', name: 'CNC / Advanced Manufacturing', shortName: 'CNCAM', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '316354', name: 'Maintenance Engineering', shortName: 'ME', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316004', name: 'Capstone Project', shortName: 'Project', type: 'Project', credits: 6, marks: 150, hours: { theory: 0, practical: 96, tutorial: 0 } }
                ]
            }
        }
    ...
    // ============================================================
    // ELECTRONICS & TELECOMMUNICATION ENGINEERING (EJ)
    // ============================================================
        ...
        semesters: {
            ...
            3: {
                ...
                subjects: [
                    ...
                    { code: '313303', name: 'Digital Techniques', shortName: 'DT', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '313326', name: 'Principles of Electronic Communication', shortName: 'PEC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '313325', name: 'Circuits & Networks', shortName: 'CN', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } }
                ]
            },
            4: {
                name: 'Semester 4',
                ...
                subjects: [
                    { code: '314326', name: 'Digital Communication Systems', shortName: 'DCS', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314327', name: 'Consumer Electronic Systems', shortName: 'CES', type: 'Theory', credits: 3, marks: 75, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    ...
                    { code: '314329', name: 'Analog & Digital Communication', shortName: 'ADC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '314301', name: 'Environmental Education and Sustainability', shortName: 'EES', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } }
                ]
            },
            5: {
                ...
                subjects: [
                    { code: '315355', name: 'Mobile & Wireless Communication', shortName: 'MWC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '315356', name: 'Embedded System', shortName: 'ES', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '315357', name: 'IoT Applications', shortName: 'IoT', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '315301', name: 'Management', shortName: 'MGT', type: 'Theory', credits: 2, marks: 50, hours: { theory: 32, practical: 0, tutorial: 0 } },
                    { code: '315004', name: 'Internship - 12 Weeks', shortName: 'INT', type: 'Internship', credits: 6, marks: 150, hours: { theory: 0, practical: 192, tutorial: 0 } }
                ]
            },
            6: {
                ...
                description: 'Final year with emerging technologies',
                subjects: [
                    { code: '316358', name: 'Optical Network and Satellite Communication', shortName: 'ONSC', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 0, tutorial: 0 } },
                    { code: '316359', name: 'Industrial Robotics and Applications', shortName: 'IRA', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 16, tutorial: 0 } },
                    { code: '316360', name: 'Industrial Internet of Things', shortName: 'IIoT', type: 'Theory', credits: 4, marks: 100, hours: { theory: 48, practical: 32, tutorial: 0 } },
                    { code: '316004', name: 'Capstone Project', shortName: 'Project', type: 'Project', credits: 6, marks: 150, hours: { theory: 0, practical: 96, tutorial: 0 } }
                ]
            }
        }
